...
Data from supplementary figure S1d can be reproduced with these [model](unet-0ce131a1-8282-464a-9b8a-e2a6a4777166.modeldef.h5) and [weight](finetuned_3.caffemodel.h5) files and [Figure_S1_Example.tif](figure_S1/Figure_S1_example.tif) (a representative image which was not part of the training set).
